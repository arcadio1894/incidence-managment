							...
							<div class="col-xs-12">
								...
								<div class="page-header">
									<h1>
										...
										<small>
											...
											Agregando categorías a un proyecto
										</small>
									</h1>
								</div>
								...
								<div class="form-horizontal" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" id="form-field-1" class="form-control" value="<?php echo $proyecto ?>" name="proyecto" readonly="true" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Nombre de categoría </label>

										<div class="col-sm-3">
											<input type="text" id="namecategory" placeholder="Categoria" class="form-control" required/>
										</div>
										<button class="btn btn-xs btn-info" id="btnAdd">
												...
												<tr>
													...
													<td class="center">
														<div class="hidden-sm hidden-xs btn-group">
															...
															<button data-delete data-id="<?php echo $row[0] ?>" data-categoria="<?php echo $row[1] ?>" class="btn btn-xs btn-danger">
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	...
																	<li>
																		<a href="#" data-delete data-id="<?php $row[0] ?>" data-categoria="<?php $row[1] ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																			<span class="red">
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h3 class="smaller lighter blue no-margin">Eliminar categoría</h3>
											</div>

											<div class="modal-body">
												<form action="" method="post" accept-charset="utf-8" >
													<strong>¿Está seguro de eliminar esta categoria?</strong>
													<p>Recuerde que si esta categoria tiene niveles asignados no se podrá eliminar.</p>
										
													<input id="idEliminado" type="hidden" name="idEliminado">
													<div class="form-group">
														<label for="categoria">Categoria:</label>
														<input type="text" name="categoria" id="categoria" readonly="true" class="form-control">
													</div>
												</form>
...
<![endif]-->
		...
		<script src="js/categoria/index.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
<?php 
