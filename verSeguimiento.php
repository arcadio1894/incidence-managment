							...
							<div class="col-xs-12">
								...
								<div class="page-header">
									<h1>
										...
										<small>
											...
											Visualizando el seguimiento de la incidencia
										</small>
									</h1>
								</div>
								...
								<?php 
									...
									$con = @mysql_connect('localhost','root','')or die ('Ha fallado la conexión: '.@mysql_error());
   									...
   									$resumen = @mysql_query("SELECT i.resumen
																FROM incidencia i 
																WHERE i.idIncidencia = ".$idIncidencia."
																")or die ('Error al seleccionar la Base de Datos: '.@mysql_error());
   									$resumen2 = "";
   									while ($row2 = @mysql_fetch_array($resumen)) 
   									{
   										$resumen2 = $resumen2.' <span class="label label-xlg label-primary arrowed arrowed-right" style="width:500px">Incidencia: '.$row2[0].'</span><br><br>';
   									}
   									echo $resumen2;
									...
									{
										$incidencias = $incidencias.'<span class="label label-xlg label-grey arrowed-in-right arrowed-in" style="width:300px">
																	'.$row[0].'
																	</span>

																	<span class="label label-xlg label-success arrowed" style="width:200px">';
																	?> 
																	<?php 

																		if ($row[1]==1) {
																			$incidencias = $incidencias.'Revisado';
																		} else {
																			$incidencias = $incidencias.'Aun no revisado';
																		}
																		
																	?>
																	<?php 
																	$incidencias = $incidencias.'</span><br><br>
										';
									}
								 ...
								 ?>
								 <br>
								 <a href="observarIncidencia.php" class="btn btn-danger btn-block">Atrás</a>
								 </div>
								<!-- PAGE CONTENT ENDS -->
							</div><!-- /.col -->
						</div><!-- /.row -->
...
<![endif]-->
		...
		<script src="js/usuario/store.js" type="text/javascript" charset="utf-8"></script>
