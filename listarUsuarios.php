					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<a href="crearUsuarios.php" class="btn btn-success">
										...
										<table id="simple-table" class="table  table-bordered table-hover">
											<thead>
												<tr>
													...
													<th class="hidden-480 center">Nivel de acceso</th>
													<th class="center">
											...
											<?php 
		    									...
		    									$res=@mysql_query("SELECT *
														FROM usuario u
														where u.enable='1'") or die("Problemas en el select:".@mysql_error());
											...
											?>
												<tr>
													...
													<td class="hidden-480 center" ><?php echo $row[5] ?></td>
													<td class="center"><?php $date = new DateTime($row[6]); echo $date->format('jS F Y'); ?></td>
													<td class="center">
														<div class="hidden-sm hidden-xs btn-group">

															<a href="editarUsuarios.php?usuario=<?php echo $row[0] ?>" class="btn btn-xs btn-info">
																<i class="ace-icon fa fa-pencil bigger-120"></i>
															</a>

															<a class="btn btn-xs btn-danger" data-eliminar data-usuario="<?php echo $row[2] ?>" data-name="<?php echo $row[1] ?>" data-id="<?php echo $row[0] ?>">
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	<li>
																		<a href="editarUsuarios.php?usuario=<?php echo $row[0] ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
																	...
																	<li>
																		<a href="#" class="tooltip-error" data-rel="tooltip" title="Delete" data-eliminar data-usuario="<?php echo $row[2] ?>" data-name="<?php echo $row[1] ?>" data-id="<?php echo $row[0] ?>">
																			<span class="red">
																				<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			</span>
																		</a>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<form action="" method="post" accept-charset="utf-8" >
													...
													<p>Recuerde que si el usuario esta asignado a un nivel no se podrá eliminar.</p>
													...
													<div class="form-group">
														...
														<input type="text" name="usuario" id="usuario" readonly="true" class="form-control">
													</div>
												</form>
...
<![endif]-->
		...
		<script src="js/usuario/main.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
<?php 
