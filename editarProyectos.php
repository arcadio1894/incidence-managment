						...
						<div class="row">
							...
							<?php 
							 ...
							 ?>
								...
								<form class="form-horizontal" role="form" id="editProject-form">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="proyecto" id="form-field-1" placeholder="Proyecto" class="form-control" value="<?php echo $proyecto ?>" required/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select class="form-control" id="estado" name="estado" >
												...
												<option value="Realese">Realese</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<textarea id="form-field-11" name="descripcion" class="autosize-transition form-control" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 92px; margin-left: 0px; margin-right: -0.015625px;"><?php echo $descripcion; ?></textarea>
										</div>
									</div>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a href="listarProyectos.php" class="btn" type="reset">
...
<![endif]-->
		...
		<script src="js/proyecto/edit.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
<?php 
