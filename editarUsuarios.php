						...
						<div class="row">
							<div class="col-xs-12">
								...
								$res=@mysql_query("SELECT *
										FROM usuario u
										where u.enable='1' AND u.idUsuario ='".$idUsuario."'") or die("Problemas en el select:".@mysql_error());
								...
								<form class="form-horizontal" role="form" id="edit-user">
									<input type="hidden" name="idUsuario" value="<?php echo $idUsuario ?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre de usuario </label>

										<div class="col-sm-4">
											<input type="text" id="form-field-1" class="form-control" name="username" value="<?php echo $row[2] ?>" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Contraseña del usuario </label>

										<div class="col-sm-4">
											<input type="text" id="form-field-2" class="form-control" name="password" value="<?php echo $row[4] ?>" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Nombre real del usuario </label>

										<div class="col-sm-4">
											<input type="text" id="form-field-2" class="form-control" name="realname" value="<?php echo $row[1] ?>" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Email del usuario </label>

										<div class="col-sm-4">
											<input type="text" id="form-field-2" class="form-control" name="email" value="<?php echo $row[3] ?>" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nivel de acceso </label>
										<?php 
											if ($row[5] == "User") {
												
										?>
										<div class="col-sm-4">
											<select class="form-control" id="form-field-select-1" name="nivel">
...
<![endif]-->
		...
		<script src="js/usuario/edit.js" type="text/javascript" charset="utf-8"></script>
