						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="page-header">
									<h1>
										Asignación de niveles a proyectos
										<small>
											<i class="ace-icon fa fa-angle-double-right"></i>
											Visualizando los proyectos registrados
										</small>
									</h1>
								</div>
								...
								<div class="form-horizontal" >
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Categorias </label>
											...
											<select class="form-control" id="categorias" name="categorias" >
												<?php 
			    									...
			    									$res=@mysql_query("SELECT *
															FROM categoria c
															where c.enable='1' AND c.idProyecto='".$idProyecto."'") or die("Problemas en el select:".@mysql_error());
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Perfiles </label>
											...
											<select class="form-control" id="perfiles" name="perfiles" >
												<?php  
													$res2=@mysql_query("SELECT *
															FROM perfil p
															where p.enable='1' ORDER BY p.nivel DESC") or die("Problemas en el select:".@mysql_error());
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Usuarios </label>
											...
											<select class="form-control" id="usuarios" name="usuarios" >
												<?php  
													$res3=@mysql_query("SELECT *
															FROM usuario u
															where u.enable='1' AND u.type='User'") or die("Problemas en el select:".@mysql_error());
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a class="btn btn-danger" href="listarNiveles.php">
									...
									<div class="col-md-offset-3 col-md-6">
										<template id="template-nivel">
                                            <tr>
                                                ...
                                                <td data-user></td>
                                                <td>
                                                    <button data-delete data-id class="btn btn-xs btn-danger"> 
														<i class="ace-icon fa fa-trash bigger-120"></i>Eliminar
													</button>
												</td>
                                            </tr>
                                        </template>
										...
										<table id="simple-table" class="table  table-bordered table-hover">
											<thead>
												<tr>
													<th class="center">Id del nivel</th>
													<th class="center">Nombre de la categoria</th>
													<th class="center">Nombre del perfil</th>
													<th class="center">Nombre del usuario</th>
													<th></th>
												</tr>
											</thead>

											<tbody id="table-nivel">
												<!-- <tr>
													<td class="center">
														Nombre proyecto 1
													</td>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h3 class="smaller lighter blue no-margin">Eliminar nivel</h3>
											</div>

											<div class="modal-body">
												<form action="" method="post" accept-charset="utf-8" >
													<strong>¿Está seguro de eliminar este nivel?</strong>
													<p>Recuerde que si la categoria a la que pertenece este nivel ya tiene una incidencia no podrá eliminar este nivel.</p>
...
<![endif]-->
		...
		<script src="js/nivel/visualizar.js" type="text/javascript" charset="utf-8"></script>
