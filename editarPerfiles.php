							...
							<div class="col-xs-12">
								...
								<?php 
									...
									$res=@mysql_query("SELECT *
											FROM perfil p
											where p.enable='1' AND p.idPerfil ='".$idPerfil."'") or die("Problemas en el select:".@mysql_error());
								...
								<form class="form-horizontal" role="form" id="edit-perfil">
									<input type="hidden" name="idPerfil" value="<?php echo $row[0] ?>">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre del perfil </label>

										<div class="col-sm-4">
											<input type="text" id="form-field-1" placeholder="Perfil" name="name" value="<?php echo $row[1] ?>" class="form-control" required/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Nivel de acceso </label>

										<div class="col-sm-4">
											<input type="text" id="form-field-2" placeholder="Nivel de acceso" name="nivel" value="<?php echo $row[2] ?>" class="form-control" required/>
										</div>
									</div>
									<?php 
									}
...
<![endif]-->
		...
		<script src="js/perfil/edit.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
<?php 
