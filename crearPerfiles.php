					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" id="register-perfil">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre del perfil </label>

										<div class="col-sm-4">
											<input type="text" id="form-field-1" placeholder="Perfil" class="form-control" name="name" required/>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" id="form-field-2" placeholder="Nivel de acceso" class="form-control" name="nivel" required/>
										</div>
									</div>
...
<![endif]-->
		...
		<script src="js/perfil/store.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
<?php 
