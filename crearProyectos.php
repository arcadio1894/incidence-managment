					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" id="project-form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nombre del Proyecto </label>

										<div class="col-sm-4">
											<input type="text" id="form-field-1" placeholder="Proyecto" class="form-control" name="proyecto" required/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select class="form-control" id="" name="visibilidad">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<textarea id="form-field-11" class="autosize-transition form-control" name="descripcion" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 92px; margin-left: 0px; margin-right: -0.015625px;"></textarea>
										</div>
									</div>
...
<![endif]-->
		...
		<script src="js/proyecto/store.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
<?php 
