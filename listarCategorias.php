						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="page-header">
									<h1>
										Listar categorias por proyectos
										<small>
												...
												<tr>
													...
													<td class="center">
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="agregarCategorias.php?idProyecto=<?php echo $row[0] ?>&proyecto=<?php echo $row[1] ?>" class="btn btn-xs btn-info">
																<i class="ace-icon glyphicon glyphicon-zoom-in bigger-120"></i>Agregar categorías
															</a>
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	<li>
																		<a href="agregarCategorias.php?idProyecto=<?php echo $row[0] ?>&proyecto=<?php echo $row[1] ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
