					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h3> LEYENDA: </h3>
								<p>
									<span class="label label-lg Nuevo">Nuevo</span>
									<span class="label label-lg Datos">Mas datos</span>
									<span class="label label-lg Aceptado">Aceptado</span>
									<span class="label label-lg Asignado">Asignado</span>
									<span class="label label-lg Resuelto">Resuelto</span>
									<span class="label label-lg Cerrado">Cerrado</span>
								</p>
									...
									<div class="row">
										<div class="col-xs-12 col-sm-6 widget-container-col" id="widget-container-col-1">
											<div class="widget-box" id="widget-box-1">
												<div class="widget-header">
													<h5 class="widget-title">Asignadas a mí</h5>
												...
												<div class="widget-body">
													<div class="widget-main" id="asignadas">
										...
										<div class="col-xs-12 col-sm-6 widget-container-col" id="widget-container-col-2">
											<div class="widget-box" id="widget-box-2">
												<div class="widget-header">
													<h5 class="widget-title">Reportadas por mí</h5>
												...
												<div class="widget-body">
													<div class="widget-main" id="reportadas">
									...
									<div class="row">
										<div class="col-xs-12 col-sm-6 widget-container-col" id="widget-container-col-3">
											<div class="widget-box" id="widget-box-3">
												<div class="widget-header">
													<h5 class="widget-title">Resueltas</h5>
												...
												<div class="widget-body">
													<div class="widget-main" id="resueltas">
										...
										<div class="col-xs-12 col-sm-6 widget-container-col" id="widget-container-col-4">
											<div class="widget-box" id="widget-box-4">
												<div class="widget-header">
													<h5 class="widget-title">Cerradas</h5>
												...
												<div class="widget-body">
													<div class="widget-main" id="cerradas">
...
<![endif]-->
		...
		<script src="js/panel/main.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
<?php 
