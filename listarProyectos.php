					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<a href="crearProyectos.php" class="btn btn-success">
										...
										<table id="simple-table" class="table  table-bordered table-hover">
											<thead>
												<tr>
													...
													<th class="hidden-480 center">Visibilidad</th>
													<th class="center">
														<i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>
														Fecha de creación
													</th >
													<th class="hidden-480 center">Descripción</th>
													<th></th>
												</tr>
											</thead>
											...
											?>
												<tr>
													...
													<td class="center">
														<?php $date = new DateTime($row[3]); echo $date->format('jS F Y'); ?>
													</td>
													<td class="hidden-480 center">
														<?php echo $row[5] ?>
													</td>
													...
													<td class="center">
														<div class="hidden-sm hidden-xs btn-group">
															...
															<a href="editarProyectos.php?idProyecto=<?php echo $row[0] ?>&proyecto=<?php echo $row[1] ?>&estado=<?php echo $row[2] ?>&visibilidad=<?php echo $row[4] ?>&descripcion=<?php echo $row[5] ?>" class="btn btn-xs btn-info">
																<i class="ace-icon glyphicon glyphicon-pencil bigger-120"></i>
															</a>
															<button class="btn btn-xs btn-danger" data-eliminar data-proyecto="<?php echo $row[1] ?>" data-id="<?php echo $row[0] ?>">
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	<li>
																		<a href="editarProyectos.php?idProyecto=<?php echo $row[0] ?>&proyecto=<?php echo $row[1] ?>&estado=<?php echo $row[2] ?>&visibilidad=<?php echo $row[4] ?>&descripcion=<?php echo $row[5] ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
																	...
																	<li>
																		<a href="#" data-eliminar class="tooltip-error" data-rel="tooltip" title="Delete" data-proyecto="<?php echo $row[1] ?>" data-id="<?php echo $row[0] ?>">
																			<span class="red">
...
<![endif]-->
		...
		<script src="js/proyecto/main.js" type="text/javascript" charset="utf-8"></script>
